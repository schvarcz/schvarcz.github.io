...
var moveToFront = Kapsule__default['default']({
  init: function init(el) {
    el.parentNode.appendChild(el);
  }
});

var gradient = Kapsule__default['default']({
  props: {
    id: {},
    // Use with: .attr('fill', 'url(#<gradId>)');
    colorScale: {
      "default": d3Scale.scaleLinear().range(['black', 'white'])
    },
    angle: {
      "default": 0
...
var dropshadow = Kapsule__default['default']({
...
var throbber = Kapsule__default['default']({
  props: {
    x: {
      "default": 0
    },
...
var image = Kapsule__default['default']({
  props: {
    imgUrl: {},
    x: {
      "default": 0
...
var zoomOverviewArea = Kapsule__default['default']({
  props: {
    selection: {
      "default": {
        x: [null, null],
